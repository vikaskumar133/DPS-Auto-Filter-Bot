...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 UPDATES 📢', url='https://t.me/dps_movies')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 caption=f'<b>ʜᴇʏ, {u.mention} 👋🏻\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴏᴜʀ ɢʀᴏᴜᴘ {message.chat.title}\n\nFind Any Movie! if you need any movie then enter the movie name + years. 👍\n\nGuys Enter Only Movie Or Webseries Name like This 👇\nPushpa ✅\nPushpa 2021 ✅\nPushpa in Telugu ❌\n\nLoki ✅\nLoki S01 ✅\nLoki all season ❌</b>',
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('  ↭ Movie Updates Channel ↭  ', url='https://t.me/dps_movies') ],
